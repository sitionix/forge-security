...
class ServiceIdResolverTest {
    ...
    @BeforeEach
    void setUp() {
        final Map<String, ForgeSecurityServerProperties.ServiceDefinition> services = new HashMap<>();
        services.put("auth", this.getServiceDefinition("sitionix.auth", List.of("auth-service", "localhost")));
        services.put("notification", this.getServiceDefinition("sitionix.notification", List.of("notification-service")));
    ...
    private ForgeSecurityServerProperties.ServiceDefinition getServiceDefinition(final String id,
                                                                                 final List<String> hosts) {
        final ForgeSecurityServerProperties.ServiceDefinition definition =
                new ForgeSecurityServerProperties.ServiceDefinition();
        definition.setId(id);
